...
if [ $SYS = "Linux" ]; then
    ...
    LIBRARIES="-L$PFM_LIB -lproj -lnvutility -lbag -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X"
    LIBRARIES="-L$PFM_LIB -lproj -lnvutility -lbag -lbeecrypt -lhdf5 -lgdal -lxml2 -lpoppler -lglu32 -lopengl32 -lwsock32 -liconv"
